...
public class VoxelRenderer : MonoBehaviour
{
    ...
    //public void GenerateVoxels(VoxelData data, Bounds bounds)
    //{
    //    voxelData = data;
    ...
    //                voxelCube.transform.position = new Vector3(x, y, z);
    //                voxelCube.transform.parent = transform;
    //            }
    //        }
    //    }
    //    transform.position = transform.position + bounds.min;
    //}
