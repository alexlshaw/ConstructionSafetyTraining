...
public class DoorNode : Node
{
    ...
    private int modifierDistanceFromWall = 0;
    public DoorNode(Node node1, Node node2, int corridorWidth) : base(null)
    {
    ...
    private void ProcessRoomInRelationRightOrLeft(Node structure1, Node structure2)
    {
        ...
        List<Node> leftStructureChildren = StructureHelper.ExtractLowestLeaves((RoomNode)structure1);
        Node rightStructure = null;
        List<Node> rightStructureChildren = StructureHelper.ExtractLowestLeaves((RoomNode)structure2);
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        List<Node> structureBottmChildren = StructureHelper.ExtractLowestLeaves((RoomNode)structure1);
        Node topStructure = null;
        List<Node> structureAboveChildren = StructureHelper.ExtractLowestLeaves((RoomNode)structure2);
